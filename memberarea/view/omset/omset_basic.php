<?php 
    ...
    $cm = new classMember();
    $omset = $cm->omset_member($session_member_id);
    $history_omset = $cm->history_omset_member($session_member_id);
?>
                    ...
                    <div class="card-body p-2">
                        <div class="row mb-2">
                            ...
                            <div class="col align-self-center ps-0">
                                <p class="mb-0 text-danger">Omset Basic</p>
                            </div>
                        </div>
                ...
                ?>
                    <div class="card mb-3 bonus-item <?=$row->posisi?>">
                        <div class="card-body">
                            <div class="row">
                                <div class="col align-self-center">
                                    <span class="mb-0 text-default size-12">Omset Basic <strong><?=ucfirst($row->posisi)?></strong> dari <?=$dari_member->nama_member?></span>
                                    <p>
                                        <span
