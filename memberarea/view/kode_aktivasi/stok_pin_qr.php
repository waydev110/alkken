        ...
        <div class="row">
            ...
            ?>
                ...
                while($row = $list_pin->fetch_object()){
                    ...
                    $link_aktivasi = 'https://mypanel.4lexa.id.com/memberarea/?go=member_create&kode_aktivasi='.$row->kode_aktivasi;
                    $qrcode = (new QRCode)->render($link_aktivasi);
                ?>
                        ...
                        <div class="row">
                            <div class="col align-self-center">
                    		    <div class="coupon bg-white rounded mb-3 d-flex justify-content-between">
                                    ...
                                    <div class="middle-coupon py-3 d-flex w-auto justify-content-start">
                                        <div>
                                            <span class="badge badge-<?=$row->status_aktivasi == '1' ? 'success' : 'default'?>"><?=$row->status_aktivasi == '1' ? 'Terpakai' : 'Belum digunakan'?></span>
                                            <h3 class="lead mt-2"><?=$row->kode_aktivasi?> </h3>
                                            <p class="text-muted mb-0"><?=rp($row->harga)?></p>
                                        </div>
                                    </div>
                                    <div class="right-coupon">
                                        <div class="info m-3 d-flex align-items-center">
                                            <div class="w-100 text-center">
                                                <div class="block">
                                                    <span class="size-11 font-weight-light">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col align-self-center">
                                ...
                                <p>
                                    <span
                                        class="text-default fw-bold mb-1 size-20"><?=currency($row->harga)?></span>
                                </p>
                            </div>
                            <div class="col-auto align-self-right text-end">
                                <p class="mb-0"><span class="text-default size-12"><?=$row->kode_aktivasi?>
                                    </span></p>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col text-center ps-0">
                                <p class="mb-0"><span class="text-muted size-12">Tidak memiliki PIN.</span></p>
