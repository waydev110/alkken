        ...
        <div class="row">
            ...
            ?>
                ...
                while($row = $list_pin->fetch_object()){
                    $tanggal =  $row->status_aktivasi == '1' ? $row->updated_at : $row->created_at;
                ...
                ?>
                    <div class="card mb-3 rounded-0 pin-item <?=$row->status_aktivasi?>">
                        <div class="card-body">
                            <div class="row">
                                <div class="col align-self-center">
                                    <p class="text-theme-color fw-semibold mb-0 size-18"><?=$row->nama_plan?></p>
                                    <p class="text-default fw-semibold mt-0 mb-1 size-16"><?=rps($row->harga)?></p>
                                </div>
                                <div class="col-auto align-self-right text-end">
                                    <p class="mb-0 text-default size-12"><?=$tanggal_bonus?></p>               
                                    <p class=" mt-0 tag text-white px-2 py-1 bg-<?=$row->status_aktivasi == '1' ? 'success' : 'dark'?> mb-0">
