<?php 
    ...
    $cr = new classRekeningPerusahaan();
    ...
    <div class="main-container container pt-4 pb-4 mb-2" id="blockFirstForm">
        <div class="card mb-4">
            <div class="card-body">
                ...
                <?php
                if($rekening_perusahaan->num_rows > 0){
                ?>
                <form action="controller/autosave/upload_bukti_bayar.php" encyptype="multipart/form-data" id="formKonfirmasi" method="post">
                    <input type="hidden" id="id_order" name="id_order" value="<?=base64_encode($id_order)?>">
                    <div class="row mb-4">
                        <div class="col">
                            <div class="pt-2 bg-white">
                                <div id="detail"><?php 
                                        while ($row = $rekening_perusahaan->fetch_object()) {
                                    ?>
                                    <div class="row mb-4">
                    ...
                    <div class="row mb-2">
                        <div class="col-12">
                            ...
                            <input type="file" placeholder="Pilih File" id="bukti_bayar" name="bukti_bayar" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 align-self-center text-end mt-0 d-xs-grid">
                            <a href="?go=riwayat_autosave" class="btn btn-outline-default btn-lg rounded-pill px-4 mb-2" id="btnKembali">KEMBALI</a>
                            <button type="button"
                ...
                ?>
                <div class="alert alert-warning" role="alert">
                    <p class="size-12">Mohon maaf kami belum input rekening. Silahkan hubungi administrator.</p>
                </div>
                <?php
                }
                ?>
