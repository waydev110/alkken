...
<main class="h-100 has-header">
    ...
    <div class="main-container container pt-4 pb-4" id="blockFirstForm">
        <form action="controller/profil/update_profil.php" id="formUpdateProfil" method="post">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="form-group form-floating-2-fix mb-4">
                        <div class="input-group">
                            <input type="text" class="form-control datepicker" id="tanggal_lahir" name="tanggal_lahir" value="<?=$member->tgl_lahir_member <> '0000-00-00' ? date('d/m/Y', strtotime($member->tgl_lahir_member)) : ''?>" autocomplete="off">
                        </div>
                ...
                <!--            <option value="<?=$row->id?>" <?=$member->id_bank == $row->id ? "selected" : ""?>>-->
                <!--                <?=$row->nama_bank?>-->
                <!--            </option>-->
                <!--            <?php } ?>-->
                <!--        </select>-->
                ...
                <!--            value="<?=$member->no_rekening?>" required="required">-->
                ...
                <!--            value="<?=$member->atas_nama_rekening?>" disabled="disabled">-->
                ...
                <!--            value="<?=$member->cabang_rekening?>" required="required">-->
    ...
    $(document).ready(function () {
        ...
        formUpdateProfil.on("submit", function (e) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result == true) {
                        var message = `Update profil berhasil. Silahkan cek perubahan di halaman profil.`;
