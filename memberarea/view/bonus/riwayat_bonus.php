        ...
        <div class="p-3 bg-light rounded-15">
            <div class="row">
                <div class="col-4">
                    ...
                    <h2 class="size-14"><?=currency($cbns->riwayat_bonus($jenis_bonus, $session_member_id))?></h2>
                </div>
                <div class="col-4">
                    <h3 class="size-14">Ditransfer</h3>
                    <h2 class="size-14"><?=currency($cbns->riwayat_bonus($jenis_bonus, $session_member_id, '1'))?></h2>
                </div>
                <div class="col-4">
                    <h3 class="size-14">Pending</h3>
                    <h2 class="size-14"><?=currency($cbns->riwayat_bonus($jenis_bonus, $session_member_id, '0'))?></h2>
                </div>
