...
if (isset($_GET["plan_reward"])) {
    ...
    $id_plan = $cpl->get_plan_reward();
}

$member = $cm->detail($session_member_id);
$poin_reward = $cm->jumlah_poin_reward($session_member_id, $id_plan);
$data = $obj->index($id_plan);
...
<main class="h-100 has-header">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col align-self-center">
                                    ...
                                    <p class="size-12 text-light">
                                        Silahkan posting ro <strong><?= $plan->show_name ?></strong> terlebih dahulu untuk dapat mengklaim reward anda.
                                    </p>
    ...
    <div class="main-container container pt-4 pb-4 mb-2" id="blockFirstForm2" style="display:none">
        <div class="card mb-4">
            <div class="card-body">
                <form action="controller/reward/klaim_reward.php" id="formKlaimReward" method="post">
...
<script>
    ...
    function KlaimReward(idreward) {
        if (idreward != "") {
            $.ajax({
                type: 'POST',
                url: 'controller/reward/cek_klaim_reward.php',
                data: {
                    idreward: idreward
                },
