...
<main class="h-100 has-header">
    ...
    <div class="main-container container pt-4 pb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-auto align-self-center">
                                    <input type="checkbox" name="checkStokis[<?=$data->id?>]"
                                        id="checkStokis<?=$data->id?>" onclick="updateCheckStokis('<?=$data->id?>')">
                                </div>
                                <div class="col-auto align-self-center ps-0">
                                    <div class="avatar avatar-60 rounded-10">
                                        <i class="fa fa-shop fa-3x"></i>
                                    </div>
                                </div>
        ...
        <div class="row mb-4">
            <div class="col">
                <div class="cart-list" id="cartList<?=$data->id?>">
                    <?php
                                ...
                                <div class="col align-self-center">
                                    <div class="row">
                                        <div class="col align-self-center pe-0">
                                            ...
                                            <h3 class="size-14 text-theme mb-2"><?=rp($row->harga)?></h3>
                                        </div>
                                        <div class="col-auto ps-0 text-end">
    ...
    <div class="container py-2 pt-4">
        <div class="row">
            <div class="col">
                ...
                <h3 class="size-18 text-theme" id="total_harga">Rp<?=currency($total_harga)?></h3>
            </div>
