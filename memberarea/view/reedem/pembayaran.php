    ...
    <div class="main-container container pt-4 pb-4 mb-2" id="blockFirstForm">
        <div class="card mb-4">
            <div class="card-body">
                ...
                ?>
                <form action="controller/reedem/upload_bukti_bayar.php" encyptype="multipart/form-data" id="formKonfirmasi" method="post">
                    ...
                    <div class="row">
                        <div class="col-12 align-self-center text-end mt-0 d-xs-grid">
                            <a href="?go=riwayat_reedem" class="btn btn-outline-default btn-lg rounded-pill px-4 mb-2" id="btnKembali">KEMBALI</a>
                            <button type="button"
