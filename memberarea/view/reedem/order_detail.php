<?php
    ...
    $objd = new classMemberReedemDetail();
                ...
                <div class="card mb-0 rounded-0">
                    <div class="card-body pt-4">
                        <div class="row border-0">
                            ...
                            <div class="col align-self-center">
                                <h3 class="size-18 mb-2 text-end"><?=rps($order->nominal+$order->saldo_poin)?></h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-0 rounded-0">
                    <div class="card-body pt-4">
                        <div class="row border-0">
                            ...
                            <div class="col align-self-center">
                                <h3 class="size-18 mb-2 text-end"><?=rps($order->saldo_poin)?></h3>
                            </div>
                        </div>
                        ...
                        <div class="row border-0">
                            ...
                            <div class="col align-self-center">
                                <h3 class="size-18 mb-2 text-end"><?=rps($order->nominal)?></h3>
                            </div>
                        </div>
                        <?php } ?>
                    </div>
