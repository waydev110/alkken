...
if ($_FILES['bukti_bayar']['size'] <> 0){
    ...
    $path = "../../../images/bukti_bayar_reedem/".$new_filename;
...
<p class="text-center text-muted mb-2 size-12">Anda dapat mengecek status pesanan anda di halaman Riwayat Order.</p>
';
