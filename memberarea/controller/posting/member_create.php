<?php
    ...
    $message = '
        <div style="max-width: 500px; margin: 0 auto; background: linear-gradient(135deg, #0033a0 0%, #0055d4 100%); border-radius: 16px; padding: 32px; box-shadow: 0 8px 32px rgba(0,0,0,0.3); border: 1px solid #d4af37;">
