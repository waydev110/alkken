        ...
        (n = [
            ...
            function (M, t, e) {
                    ...
                    hide() {
                        if (this._isShown()) {
                            ...
                            if (!t.defaultPrevented) {
                                ...
                                if ((e.classList.remove(qo), "ontouchstart" in document.documentElement)) for (const n of [].concat(...document.body.children)) f.off(n, "mouseover", pt);
                                (this._activeTrigger.click = !1), (this._activeTrigger[Uo] = !1), (this._activeTrigger[Vo] = !1), (this._isHovered = null);
                                this._queueCallback(
                                    () => {
                                        this._isWithActiveTrigger() ||
                                            (this._isHovered || e.remove(), this._element.removeAttribute("aria-describedby"), f.trigger(this._element, this.constructor.eventName("hidden")), this._disposePopper());
                                    },
                                    this.tip,
                                    this._isAnimated()
                                );
                ...
                const gr = "active",
                    mr = "[href]";
                g = ".nav-link";
                const _r = "".concat(g, ", ").concat(".nav-item", " > ").concat(g, ", ").concat(".list-group-item"),
                ...
                f.on(window, w, () => {
                    for (const t of y.find('[data-mdb-spy="scroll"]')) yr.getOrCreateInstance(t);
                }),
                    t(yr);
                v = yr;
                const wr = "scrollspy";
                (E = "mdb.".concat(wr)), (g = ".".concat(E));
                const Er = "activate.bs.scrollspy",
                    xr = "activate".concat(g);
                w = "load".concat(g).concat(".data-api");
                ...
                class Or extends v {
                    ...
                    _bindActivateEvent() {
                        s.on(this._scrollElement, Er, (t) => {
                            this._showSubsection(), this._hideSubsection(), s.trigger(this._scrollElement, xr, { relatedTarget: t.relatedTarget });
                        });
                    }
                }
                s.on(window, w, () => {
                ...
                var Sr = Or;
                E = ".".concat("bs.tab");
                const Lr = "hide".concat(E),
                    Ir = "hidden".concat(E),
                    kr = "show".concat(E),
                    Dr = "shown".concat(E);
                g = "click".concat(E);
                const jr = "keydown".concat(E);
                v = "load".concat(E);
                const Pr = "ArrowRight",
                    Nr = "ArrowDown",
                    Mr = "active",
                ...
                (E = ".nav-link".concat(w, ", .list-group-item").concat(w, ', [role="tab"]').concat(w)), (w = '[data-mdb-toggle="tab"], [data-mdb-toggle="pill"], [data-mdb-toggle="list"]');
                const Rr = "".concat(E, ", ").concat(w),
                ...
                var Vs = j;
                const Us = "dropdown";
                (w = ".".concat("bs.dropdown")), (v = ".data-api");
                const Ys = "ArrowDown",
                    Xs = "hide".concat(w),
                    Ks = "hidden".concat(w),
                    $s = "show".concat(w),
                    Gs = "shown".concat(w);
                (g = "click".concat(w).concat(v)), (E = "keydown".concat(w).concat(v)), (e = "keyup".concat(w).concat(v));
                const Zs = "show",
