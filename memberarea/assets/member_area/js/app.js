! function(s) {
    ...
    function a(e) {
        document.getElementById("header-lang-img") && ("en" == e ? document.getElementById("header-lang-img").src = base_url("assets/member_area/images/flags/us.jpg") : "sp" == e ? document.getElementById("header-lang-img").src = base_url("assets/member_area/images/flags/spain.jpg") : "gr" == e ? document.getElementById("header-lang-img").src = base_url("assets/member_area/images/flags/germany.jpg") : "it" == e ? document.getElementById("header-lang-img").src = base_url("assets/member_area/images/flags/italy.jpg") : "ru" == e && (document.getElementById("header-lang-img").src = base_url("assets/member_area/images/flags/russia.jpg")), localStorage.setItem("language", e), null == (t = localStorage.getItem("language")) && a(n), s.getJSON(base_url("assets/member_area/lang/" + t + ".json"), function(e) {
    ...
    function r(e) {
        1 == s("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (s("html").removeAttr("dir"), s("#dark-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#dark-rtl-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", base_url("assets/member_area/css/bootstrap.min.css")), s("#app-style").attr("href", base_url("assets/member_area/css/app.min.css")), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == s("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (s("html").removeAttr("dir"), s("#light-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#dark-rtl-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", base_url("assets/member_area/css/bootstrap-dark.min.css")), s("#app-style").attr("href", base_url("assets/member_area/css/app-dark.min.css")), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == s("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e ? (s("#light-mode-switch").prop("checked", !1), s("#dark-mode-switch").prop("checked", !1), s("#dark-rtl-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", base_url("assets/member_area/css/bootstrap-rtl.min.css")), s("#app-style").attr("href", base_url("assets/member_area/css/app-rtl.min.css")), s("html").attr("dir", "rtl"), sessionStorage.setItem("is_visited", "rtl-mode-switch")) : 1 == s("#dark-rtl-mode-switch").prop("checked") && "dark-rtl-mode-switch" === e && (s("#light-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#dark-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", base_url("assets/member_area/css/bootstrap-dark-rtl.min.css")), s("#app-style").attr("href", base_url("assets/member_area/css/app-dark-rtl.min.css")), s("html").attr("dir", "rtl"), sessionStorage.setItem("is_visited", "dark-rtl-mode-switch"))
    }
