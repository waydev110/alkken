...
<main class="h-100 has-header">
    ...
    <!-- main page content -->
    <div class="main-container container mt-4 pt-4 pb-4">
        ...
        <div class="row h-100 ">
            <div class="col-12 col-md-6 col-lg-5 col-xl-3 mx-auto py-4 text-center align-self-center">
                ...
                <p class="text-muted mb-4">The page you are looking for is not found or removed. Please try again
                    sometime or go back to home page.</p>

                <a href="index.php" target="_self" class="btn btn-default btn-lg">Back to Home</a>
            </div>
        </div>
    </div>
