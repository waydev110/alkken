...
class classStokisDepositCart{
    ...
    public function create(){
        $sql  = "INSERT INTO mlm_stokis_deposit_cart (
                    id_stokis_tujuan, 
                    id_stokis, 
                    id_produk, 
                    qty, 
    ...
    public function update(){
        $sql  = "UPDATE mlm_stokis_deposit_cart SET
    ...
    public function total_diskon($id_stokis, $id_stokis_tujuan){
        ...
        $persentase_fee = $persentase_fee/100;
        if($persentase_fee > 0){
