...
class classTransferKodeAktivasiRo{
    ...
    public function transfer($id){
        $sql  = "SELECT tk.*, k.jumlah_hu, k.harga FROM mlm_kodeaktivasi_ro_transfer tk 
				LEFT JOIN mlm_kodeaktivasi_ro k ON tk.id_kodeaktivasi = k.id 
	...
	public function create(){
		$sql 	= "INSERT INTO mlm_kodeaktivasi_ro_transfer (
                        id_member_lama, 
                        id_member_baru, 
                        id_kodeaktivasi, 
                        created_at
	...
	public function destroy($id){
		$sql  = "DELETE FROM mlm_kodeaktivasi_ro_transfer WHERE id = '$id'";		
		$c    = new classConnection();
		$query  = $c->_query($sql);
		return $query;
	}
	...
	public function history($id_kodeaktivasi){
		$sql  = "SELECT t.created_at, 
                    ...
                    FROM mlm_kodeaktivasi_ro_transfer t
