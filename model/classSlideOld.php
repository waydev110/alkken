...
class classSlide {
	...
	public function create(){
		$sql 	= "INSERT INTO mlm_slide_show(gambar, ordering, publish_status,created_at,id_admin) values ('".$this->get_gambar()."', '".$this->get_ordering()."', '".$this->get_publish_status()."', '".date('Y-m-d H:i:s', time())."', '".$this->get_id_admin()."')";
		$c 		= new classConnection();
