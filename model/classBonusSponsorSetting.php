<?php
    ...
    class classBonusSponsorSetting{
        private $id_paket;
        ...
        {
            $sql 	= "INSERT INTO mlm_bonus_sponsor_setting(
                            id_paket, 
                            persentase_bonus,
                            created_at
                        ) 
        ...
        public function update($id){
            $sql  = "UPDATE mlm_bonus_sponsor_setting SET  
        ...
        public function index(){
            $sql  = "SELECT s.*, p.nama_paket 
                        FROM mlm_bonus_sponsor_setting s
        ...
        public function show($id){
            $sql  = "SELECT * FROM mlm_bonus_sponsor_setting WHERE id_paket = '$id'";
            $c    = new classConnection();
