<?php
    ...
    while($row = $kode_aktivasi->fetch_object()){
        ...
        $bonus_generasi = $row->bonus_generasi;
        ...
        echo 'Bonus Generasi :'.$bonus_generasi.'<br>';
        echo 'Max Level :'.$max.'<br>';
        echo 'Created :'.$created_at.'<br>';
        echo 'Keterangan :'.$keterangan.'<br><br>';
        $obj->create_rekap($member_id, $id_member, $nama_samaran, $bonus_generasi, $jenis_bonus, $keterangan, $id_kodeaktivasi, $max, $created_at, $bulan);
    }
    echo 'Rekap Selesai';