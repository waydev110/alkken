                ...
                <form class="form-horizontal" enctype="multipart/form-data"
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="kode_id" id="kode_id" required="required">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control autonumeric" name="harga_paket" id="harga_paket" required="required">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="number" class="form-control" name="persentase_fee" id="persentase_fee" required="required">
