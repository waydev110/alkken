        ...
        <div class="box box-primary">
            ...
            <div class="box-body box-profile">
                <form class="form-horizontal" enctype="multipart/form-data"
                    action="controller/<?=$mod_url?>/<?=$mod_url?>_edit.php" method="post" id="formCreate">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control select2" id="id_paket" name="id_paket" required="required">
                                    ...
                                    ?>
                                    <option value="<?=$row->id?>" <?=$row->id == $data->id_paket ? 'selected' : ''?>><?=$row->nama_paket?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="form-group">
                            <label for="wa_stokis" class="col-sm-3 control-label">No WhatsApp</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="wa_stokis" id="wa_stokis" value="<?=$data->no_handphone?>">
                        ...
                        <!--</div>-->
                        <?php 
                        // require_once("view/component/alamat_edit.php"); 
                        ?>
                        <!-- <div class="form-group border-bottom-1">
