                ...
                <form class="form-horizontal" enctype="multipart/form-data"
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <img src="../images/peringkat/<?=$data->gambar?>" width="100">
                            </div>
                            <?php }?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">Nama Peringkat</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nama_peringkat" name="nama_peringkat"
                                    placeholder="masukkan nama peringkat" value="<?=$data->nama_peringkat;?>"
                                    required="required">
                            </div>
                        </div>
                        <div class="form-group">
