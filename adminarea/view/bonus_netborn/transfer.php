<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Transfer <?=$title?></h3>
...
<script>
    ...
    $(document).ready(function () {
        dataTable = $("#dataTable").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "controller/bonus_netborn/transfer.php",
                type: "post",
    ...
    function transfer(id_member, tanggal, nominal_bonus, e){
        $.ajax({
            url: 'controller/bonus_netborn/proses.php',
            type: 'post',
            data: {
                    id_member:id_member, 
                    tanggal:tanggal, 
    ...
    function reject(id_member, tanggal, nominal_bonus, e){
        $.ajax({
            url: 'controller/bonus_netborn/reject.php',
            type: 'post',
            data: {
                    id_member:id_member, 
                    tanggal:tanggal, 
