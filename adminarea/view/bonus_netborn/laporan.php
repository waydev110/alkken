<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Laporan <?=$title?></h3>
        ...
        <table class="table table-striped table-hover" border="1" bordercolor="#ddd" id="dataTable">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Pasangan Level</th>
                    <th class="text-center">Generasi</th>
                    <th class="text-center">Titik</th>
                    <th class="text-center">Sharing Profit</th>
...
<script>
    ...
    $(document).ready(function () {
        dataTable = $("#dataTable").DataTable({
            sDom: "<'row mt-4'<'col-sm-6'l><'col-sm-6'<'d-flex justify-content-end'fB>>><'table-responsive't><'row'<'col-sm-6'i><'col-sm-6'p>>",
            buttons: [
                {
                    extend: 'copyHtml5',
            ...
            serverSide: true,
            ajax: {
                url: "controller/bonus_netborn/laporan.php",
                type: "post",
                data: function(d) {
    ...
    function send_notif(id_member, tanggal, nominal_bonus, e){
        $.ajax({
            url: 'controller/bonus_netborn/send_notif.php',
            type: 'post',
            data: {
                    id_member:id_member, 
                    tanggal:tanggal, 
