        ...
        <div class="box box-primary">
            ...
            <div class="box-body box-profile">
                <form class="form-horizontal" enctype="multipart/form-data"
                    action="controller/<?=$mod_url?>/rekening_create.php" method="post">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="no_rekening" name="no_rekening" required="required">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="atas_nama_rekening" class="col-sm-3 control-label">Atas Nama</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="atas_nama_rekening" name="atas_nama_rekening" required="required">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="cabang_rekening" class="col-sm-3 control-label">Cabang</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="cabang_rekening" name="cabang_rekening" required="required">
                            </div>
                        </div>
                        <div class="bottom">
