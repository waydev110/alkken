                ...
                <form class="form-horizontal" enctype="multipart/form-data"
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control autonumeric2" name="nominal_bonus" required="required"
                                        id="nominal_bonus">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" name="max_pasangan" id="max_pasangan" required="required">
                            </div>
                        </div>
                        <div class="bottom">
