            ...
            <table class="table table-striped table-hover" border="1" bordercolor="#ddd" id="example1">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Nama <?=$lang['paket']?></th>
                        <th class="text-center">Max Pasangan</th>
                ...
                ?>
                    <tr>
                        ...
                        <td align="left"><?=$row->nama_paket?></td>
                        <td align="right"><?=currency($row->max_pasangan)?></td>
                        <td align="right"><?=currency($row->nominal_bonus)?></td>
                        <td align="center">
                            <a href='index.php?go=<?=$mod_url?>_edit&id="<?=base64_encode($row->id_paket)?>"'
