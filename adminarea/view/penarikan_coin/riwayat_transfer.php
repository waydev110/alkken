        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="?go=transfer_penarikan_coin" class="btn btn-primary btn-sm pull-right"><i class="fas fa-paper-plane"></i>
                        Transfer Coin</a>
                </div>
            </div>
                    ...
                    <table class="table table-bordered" id="example1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right"><?=$data->rate_coin?></td>
                                <td class="text-right"><?=$data->total_coin?></td>
