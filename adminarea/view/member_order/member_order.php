...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Daftar Member order</h3>
        <div class="box-tools pull-right">
            <a href="index.php?go=member_order" class="btn btn-sm <?=$status == '' ? 'btn-primary' : 'btn-default'?>">Semua</a>
            <a href="index.php?go=member_order&status=0" class="btn btn-sm <?=$status == '0' ? 'btn-primary' : 'btn-default'?>">Pending</a>
            <a href="index.php?go=member_order&status=1" class="btn btn-sm <?=$status == '1' ? 'btn-primary' : 'btn-default'?>">Diproses</a>
            <a href="index.php?go=member_order&status=2" class="btn btn-sm <?=$status == '2' ? 'btn-primary' : 'btn-default'?>">Dikirim</a>
            <a href="index.php?go=member_order&status=3" class="btn btn-sm <?=$status == '3' ? 'btn-primary' : 'btn-default'?>">Selesai</a>
            <a href="index.php?go=member_order&status=4" class="btn btn-sm <?=$status == '4' ? 'btn-primary' : 'btn-default'?>">Ditolak</a>
            <a href="index.php?go=member_order&status=5" class="btn btn-sm <?=$status == '5' ? 'btn-primary' : 'btn-default'?>">Dibatalkan</a>
        </div>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
        <div class="table-responsive">
          ...
          while ($data = $query->fetch_object()) {
            ...
            $nama_stokis = '<strong>'.$data->nama_stokis.' </strong><br>';
            $id_stokis = '<strong>'.$data->id_stokis.' </strong><br>';
            $kota_stokis = '<strong>'.$data->kota_stokis.' </strong><br>';
            $hp_stokis = 'No. Telp :'.$data->hp_stokis.' <br><br>';

            $data_stokis = $nama_stokis.$id_stokis.$kota_stokis.$hp_stokis;
            ?>
                    <tr>
                        ...
                        <td class="text-left"><?=$data_stokis?></td>                   
                        ...
                        <td class="text-center">
                            ...
                            <a href="../images/bukti_bayar/<?=$data->bukti_bayar?>" class="btn btn-success btn-xs" target="_blank"><i
                                    class="fa fa-eye"></i> Lihat Bukti Transfer</a>   
                            <?php
