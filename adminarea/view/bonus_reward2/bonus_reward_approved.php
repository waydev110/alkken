<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <a href="?go=<?=$mod_url?>" class="btn btn-primary btn-sm pull-right"><i class="fa fa-paper-plane"></i>
            Approve Bonus</a>
    </div>
    <div class="box-body">
        <?=vrekap_bonus()?>
        <table class="table table-striped table-hover" border="1" bordercolor="#ddd" id="dataTable">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Tgl Approved</th>
                </tr>
            </thead>
            <tbody>
            </tbody>
...
<script>
    ...
    $(document).ready(function () {
        dataTable = $("#dataTable").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "controller/bonus_reward/bonus_reward_approved.php",
                type: "post",
    ...
    function send_notif(id_member, tanggal){
        $.ajax({
